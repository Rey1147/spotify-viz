...
const PlayerView = (props: PlayerViewProps) => {
  const {albumImage, track, artists, isPlaying, formatDuration, displayProgress, durationMs} = props
  return (
    <div className={styles.player}>
      ...
      <div className={styles.player__track}>
        <div className={styles.player__track_name}>{track?.name}{track?.explicit && <span> E</span>}</div>
